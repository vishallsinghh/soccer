...
const Navbar = () => {
  return (
    <div className="ud-header bg-gray-800 absolute left-0 top-0 z-40 flex w-full items-center ">
      <div className="container">
        <div className="relative -mx-4 flex items-center justify-between">
          <div className="w-30 max-w-full px-4">
            <a
              href="index.html"
              className="navbar-logo flex gap-2 text-white text-3xl block w-full py-5"
            >
              <img
                src="/assets/images/techfinna-logo.png"
                alt="logo"
                className="header-logo w-8"
              />
              <h2>Techfinna</h2>
            </a>
          </div>
